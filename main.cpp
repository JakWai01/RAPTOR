...
int main(int argc, char *argv[])
{
    ...
    /*{
        ...
        {
            writer << query.source << " " << query.target << " " << query.departure_time << "\n";
        }
        writer.close();
    }*/
    ...
    cout << "Queries took " << std::chrono::duration_cast<std::chrono::duration<double>>(end - start).count() / queries.size() << " seconds on average" << endl;
